...
//go:generate minimock -i github.com/KulaginNikita/pvz-service/internal/repository/userrepo.UserRepository -o user_repository_mock.go -n UserRepositoryMock -p mocks
...
// UserRepositoryMock implements mm_userrepo.UserRepository
type UserRepositoryMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcCreate          func(ctx context.Context, u *model.User) (err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, u *model.User)
...
// NewUserRepositoryMock returns a mock for mm_userrepo.UserRepository
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, u *model.User) *mUserRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserRepositoryMockCreateParams{ctx, u}
...
// ExpectUParam2 sets up expected param u for UserRepository.Create
func (mmCreate *mUserRepositoryMockCreate) ExpectUParam2(u *model.User) *mUserRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, u *model.User)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, u *model.User) (err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, u *model.User) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &UserRepositoryMockCreateParams{ctx, u},
...
// Create implements mm_userrepo.UserRepository
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, u *model.User) (err error) {
	...
	mm_params := UserRepositoryMockCreateParams{ctx, u}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockCreateParams{ctx, u}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.u != nil && !minimock.Equal(*mm_want_ptrs.u, mm_got.u) {
				mmCreate.t.Errorf("UserRepositoryMock.Create got unexpected parameter u, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreate.t.Fatalf("Unexpected call to UserRepositoryMock.Create. %v %v", ctx, u)
	return
}
...
// GetByEmail implements mm_userrepo.UserRepository
